                  ...
                  <div className="task-item-buttons">
                    <button
                      ...
                      className={`toggle-complete-button ${
                        item.completed ? "completed-btn" : "no-completed-btn"
                      }`}
                    >
                      {item.completed
                        ? t("todo-detail-page.mark-as-not-completed")
                        : t("todo-detail-page.mark-as-completed")}
                    </button>
                    <button
          ...
          <>
            {confirmDelete ? (
              <div className="confirm-delete-container">
                ...
                >
                  {t("todo-detail-page.yes-delete")}
                </button>
                <button onClick={cancelDelete} className="delete-list-button">
                  {t("todo-detail-page.cancel")}
                </button>
              </div>
            ) : (
              <button
            ...
            >
              {list.completed
                ? t("todo-detail-page.mark-as-not-archieved")
                : t("todo-detail-page.mark-as-archieved")}
            </button>
            <button className="members-button">
              ...
              >
                {t("todo-detail-page.add-members")}
              </Link>
            </button>
          </>
        )}
        {list.owner._id !== user.id && (
          <button onClick={handleLeaveList} className="leave-list-button">
            {t("todo-detail-page.leave-list")}
          </button>
        )}
      </div>
    </div>
